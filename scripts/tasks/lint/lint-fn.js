...
export async function lintCssFn(filePath) {
    const prettierCommand = `${PRETTIER} --write ${filePath}`;
    const command = `${STYLELINT} --fix ${filePath} -o ${OUTPUT_LINT_OUTPUT_PROCESS}`;
    console.log(command);
