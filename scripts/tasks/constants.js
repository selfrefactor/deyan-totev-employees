...
export const scriptsDirectory = resolve(__dirname, '../');
...
export const CONFIG_KEYS = {
	LINT_FOLDERS: 'lintFolders',
	LINT_EXTENSIONS: 'lintExtensions',
	TEST_FOLDERS: 'testFolders',
	TEST_EXTENSIONS: 'testExtensions',
}